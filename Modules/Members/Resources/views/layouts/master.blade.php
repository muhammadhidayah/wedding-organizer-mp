            ...
            @if (Auth::check())
                <div class="dropdown ml-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="addVendor.html">MANAGE VENDOR</a>
	...
	<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          ...
          <div class="text-right">      
            ...
            <!-- Button trigger modal -->
            <button type="button" class="btn login" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#forgotModal">
              <a href="#" id="linkForgot">Forget Password</a>
            </button>
          </div>
          </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-success btn-block" data-dismiss="modal">SIGN IN</button>
            </div>
      ...
      <div class="modal fade" id="forgotModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-success btn-block" id="btnRecover" data-dismiss="modal">email me a recovery link</button>
            </div>
          </div>
        </div>
      </div>
